...
{
//stepperCalibration();
stepsToInches(xpulse,xdir,10000);
i=0;
stepsToInches(ypulse,ydir,10000);
i=0;
stepsToInches(zpulse,zdir,10000);
state=MENU;
}
...
void runHomeState()
{
  ...
  zeroStepper(zpulse,zdir,yEnd);
  stepper3.setCurrentPosition(500);
  zeroStepper(xpulse,xdir,zEnd);
  stepper.setCurrentPosition(500);
  zeroStepper(ypulse,ydir,xEnd);
